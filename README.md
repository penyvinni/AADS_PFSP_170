...
Το αρχείο που περιέχει την υλοποίηση του αλγορίθμου NEH ονομάζεται ***neh_algorithm*** `neh_algorithm` και εκτελείται ως εξής:
```
...
Το αρχείο που περιέχει την υλοποίηση του βελτιωμένου αλγορίθμου NEH ονομάζεται ***neh_square*** `neh_square` και εκτελείται ως εξής:
```
...
Το αρχείο που περιέχει την υλοποίηση του αλγορίθμου Tabu ονομάζεται ***tabu_algorithm***  `tabu_algorithm` και εκτελείται ως εξής:
```
